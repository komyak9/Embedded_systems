...
void TIM7_IRQ_HANDLER(){
    ...
    HAL_GPIO_WritePin(GPIOD, leds_num[i % 8], GPIO_PIN_SET);
    HAL_GPIO_WritePin(GPIOD, leds_num[(i + 1) % 8], GPIO_PIN_SET);
    HAL_GPIO_WritePin(GPIOD, leds_num[(i + 2) % 8], GPIO_PIN_SET);
    i++;
